...
exports.DisponibilidadRepository = void 0;
const db_1 = require("../config/db");
exports.DisponibilidadRepository = {
    // Control de Aforo Máximo[cite: 1]
    async obtenerCapacidadMaxima() {
        try {
            // Intenta buscar la configuración global en la BD[cite: 1]
            const result = await db_1.pool.query("SELECT valor FROM Configuracion WHERE clave = 'capacidad_maxima'");
